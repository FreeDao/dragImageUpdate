...
<body>
 ...
 <h1 style="text-align:center;" >修改医院信息</h1>
<form action="../php/save_base.php" method="post" id="frm">
<input type="hidden" id = "yyid" name = "yyid"></input>
	<div class="key">
        ...
        <tr>
             ...
             <tr>
                ...
                <td valign="top" align="left">
                    <select name="yydj" id="yydj" class="slt">
...
//         echo ' $("#yymc").val('.$row['dqbh'].');';
        ...
        echo 'xgdj("'.$row['yydj'].'");';
        echo 'setYyid("'.$row['yyid'].'");';
      
        echo ' $("#clsj").val("'.$row['clsj'].'");';
        echo ' $("#fwdh").val("'.$row['dh'].'");';
      
        
        echo ' $("#yyjj").val("'.$row['yyjj'].'");';
